...
@Entity
@Table(name = "cart") // Ensure the table name is correct if it is different
public class Cart {
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private int cartid; // Cart ID (auto-generated)
    ...
    public Cart(Customer customer, Animal animal) {
        this.customer = customer;
        this.animal = animal;
    }

    // New constructor for CartController
    public Cart(int cid, int aid) {
